...
module.exports = function (app, express) {
    ...
    Router.post('/selfActivity', function (req, res) {
        ...
        var getActivityData = function (cb) {
            var selfActivityQuery = 'OPTIONAL MATCH (a : User)-[nt1 : Notification ]->(b : User {username : "' + username + '"})  OPTIONAL MATCH (a)<-[f : FOLLOWS]-(b) '
                ...
                + 'coupon : xx.coupon,couponDiscount : xx.couponDiscount,discount : xx.discount,discountedPrice : xx.discountedPrice,isTodaysOffer:xx.isTodaysOffer,isRfp:xx.isRfp,'
                ...
                + 'WITH COLLECT({username : b.username, userType : b.userType, memberType : a.userType, membername : a.username, notificationId : ID(nt1), notificationMessage : nt1.message, '
                ...
                + 'createdOn : nt1.createdOn,  notificationType : nt1.notificationType, seenStatus : nt1.seenStatus, userType : c.userType, memberType : a.userType, '
                + 'postId : b.postId, productName : b.productName, coupon : b.coupon,couponDiscount : b.couponDiscount,discount : b.discount,discountedPrice : b.discountedPrice, isRfp : b.isRfp,  isTodaysOffer : b.isTodaysOffer, thumbnailImageUrl : b.thumbnailImageUrl, memberProfilePicUrl : a.profilePicUrl}) AS allRows1 '
                ...
                + 'WITH allRows1 + COLLECT ({notificationId : ID(nt1), notificationMessage : nt1.message, membername : a.username, username : c.username, userType : c.userType, memberType : a.userType, '
                + 'createdOn : nt1.createdOn, notificationType : nt1.notificationType, seenStatus : nt1.seenStatus, '
                + 'postId : b.postId, productName : b.productName, coupon : b.coupon,couponDiscount : b.couponDiscount,discount : b.discount,discountedPrice : b.discountedPrice, isRfp : b.isRfp,  isTodaysOffer : b.isTodaysOffer, thumbnailImageUrl : b.thumbnailImageUrl, memberProfilePicUrl : a.profilePicUrl}) AS allRows2 '
                ...
                + 'WITH allRows2 + COLLECT(DISTINCT {username : seller.username,   userType : seller.userType, memberType : buyer.userType, membername : buyer.username, mqttId : buyer.mqttId,  memberProfilePicUrl : buyer.profilePicUrl, notificationId : ID(nt2), '
                + 'notificationMessage : nt2.message, createdOn : nt2.createdOn, notificationType : nt2.notificationType, seenStatus : nt2.seenStatus, '
                + 'offerType : nt2.offerType, followRequestStatus : f.followRequestStatus, postId : posts2.postId, productName : posts2.productName, coupon : posts2.coupon,couponDiscount : posts2.couponDiscount,discount : posts2.discount,discountedPrice : posts2.discountedPrice, isRfp : posts2.isRfp,  isTodaysOffer : posts2.isTodaysOffer, thumbnailImageUrl : posts2.thumbnailImageUrl}) AS allRows3 '
                ...
                + 'OPTIONAL MATCH (seller)-[f : FOLLOWS]->(buyer) '
                + 'WITH allRows3 + COLLECT(DISTINCT {membername : seller.username ,username : buyer.username, userType : buyer.userType, memberType : seller.userType, mqttId : buyer.mqttId,  memberProfilePicUrl : seller.profilePicUrl, notificationId : ID(nt2), '
                + 'notificationMessage : nt2.message, createdOn : nt2.createdOn, notificationType : nt2.notificationType, seenStatus : nt2.seenStatus, '
                + 'offerType : nt2.offerType, followRequestStatus : f.followRequestStatus, postId : posts2.postId, productName : posts2.productName, coupon : posts2.coupon,couponDiscount : posts2.couponDiscount,discount : posts2.discount,discountedPrice : posts2.discountedPrice, isRfp : posts2.isRfp,  isTodaysOffer : posts2.isTodaysOffer, thumbnailImageUrl : posts2.thumbnailImageUrl}) AS allRows4 '
                ...
                + 'WITH allRows4 +  COLLECT(DISTINCT {membername : seller.username ,  username : buyer.username, memberType : seller.userType, userType : buyer.userType, mqttId : buyer.mqttId,  memberProfilePicUrl : seller.profilePicUrl, notificationId : ID(nt), '
                + 'notificationMessage : nt.message, createdOn : nt.createdOn, notificationType : nt.notificationType, seenStatus : nt.seenStatus, '
                + 'offerType : nt.offerType, followRequestStatus : f.followRequestStatus, postId : nt.postId, productName : nt.productName, coupon : nt.coupon,couponDiscount : nt.couponDiscount,discount : nt.discount,discountedPrice : nt.discountedPrice, isRfp : nt.isRfp,  isTodaysOffer : nt.isTodaysOffer, thumbnailImageUrl : nt.thumbnailImageUrl}) AS allRows5 '
                ...
                + 'OPTIONAL MATCH (buyer)-[f : FOLLOWS]->(seller) '
                + 'WITH allRows5 + COLLECT(DISTINCT {username : buyer.username, memberType : seller.userType, userType : buyer.userType, membername : seller.username, mqttId : buyer.mqttId, memberProfilePicUrl : seller.profilePicUrl, notificationId : ID(nt3), '
                ...
                + 'offerType : nt3.offerType, followRequestStatus : f.followRequestStatus, postId : posts3.postId, productName : posts3.productName, coupon : posts3.coupon,couponDiscount : posts3.couponDiscount,discount : posts3.discount,discountedPrice : posts3.discountedPrice, isRfp : posts3.isRfp,  isTodaysOffer : posts3.isTodaysOffer, thumbnailImageUrl : posts3.thumbnailImageUrl, productName : posts3.productName}) AS allRows '
                + 'UNWIND allRows AS row WITH '
                + 'row.username AS username, row.membername AS membername,row.userType AS userType, row.memberType AS memberType, row.notificationId AS notificationId, row.notificationMessage AS notificationMessage, '
                + 'row.createdOn AS createdOn, row.notificationType AS notificationType, row.seenStatus AS seenStatus, row.postId AS postId, '
                // + 'coupon : row.coupon ,couponDiscount : row.couponDiscount, discount : row.discount, discountedPrice : row.discountedPrice, isTodaysOffer:row.isTodaysOffer, isRfp:row.isRfp,'
                + 'row.coupon AS coupon, row.couponDiscount AS couponDiscount, row.discount AS discount, row.discountedPrice AS discountedPrice, row.isTodaysOffer AS isTodaysOffer, row.isRfp AS isRfp, '
                ...
                + 'RETURN username, userType, membername, memberType, notificationId, notificationMessage, memberIsPrivate,mqttId, '
                + 'coupon, couponDiscount, discount, discountedPrice, isTodaysOffer, isRfp, '
        ...
        async.waterfall(stack, function (e, d) {
    ...
    Router.post('/followingActivity', function (req, res) {
        ...
        var followingActivityQuery = 'OPTIONAL MATCH (a : User {username : "' + username + '"})-[f : FOLLOWS]->(b : User)-[nt : Notification]->(c : User) '
            ...
            + 'WITH COLLECT({user1_username : b.username, user1_userType : b.userType, user1_fullName : b.fullName, user1_profilePicUrl : b.profilePicUrl, user2_username : c.username, user2_userType : c.userType, '
            ...
            + 'WITH row1 + COLLECT ({user1_username : b.username, user1_userType : b.userType, user1_fullName : b.fullName, user1_profilePicUrl : b.profilePicUrl, '
            + 'user2_username : c.username, user2_userType : c.userType, user2_fullname : c.fullName, user2_profilePicUrl : c.profilePicUrl, notificationId : ID(nt), '
            ...
            + 'isTodaysOffer : posts.isTodaysOffer, isRfp : posts.isRfp, discount : posts.discount, discountedPrice : posts.discountedPrice, coupon : posts.coupon, couponDiscount : posts.couponDiscount, '
            + 'thumbnailImageUrl : posts.thumbnailImageUrl, mainUrl : posts.mainUrl, postId : posts.postId, productName : posts.productName}) AS allRows UNWIND allRows AS row WITH '
            + 'row.user1_username AS user1_username, row.user1_userType AS user1_userType, row.user1_fullName AS user1_fullName, row.user1_profilePicUrl AS user1_profilePicUrl, '
            + 'row.user2_username AS user2_username, row.user2_userType AS user2_userType, row.user2_fullname AS user2_fullname, row.user2_profilePicUrl AS user2_profilePicUrl, '
            ...
            + 'row.thumbnailImageUrl AS thumbnailImageUrl, row.mainUrl AS mainUrl, row.postId AS postId, row.productName AS productName, '
            + 'row.isTodaysOffer AS isTodaysOffer, row.isRfp AS isRfp, row.discount AS discount, row.discountedPrice AS discountedPrice,  row.coupon AS coupon,  row.couponDiscount AS couponDiscount '
            + 'RETURN DISTINCT user1_username, user1_userType, user1_fullName, user1_profilePicUrl, user2_username, user2_userType, user2_fullname, user2_profilePicUrl, '
            + 'notificationId, notificationMessage, createdOn, notificationType, seenStatus, postsType, postedOn, thumbnailImageUrl, mainUrl, postId, productName, '
            + 'isTodaysOffer, isRfp, discount, discountedPrice, coupon, couponDiscount '
            + 'ORDER BY(createdOn) DESC SKIP ' + offset + ' LIMIT ' + limit + '; ';
